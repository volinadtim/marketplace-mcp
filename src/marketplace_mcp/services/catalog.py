...
from marketplace_mcp.constants import (
    PURCHASE_SORTS,
    PURCHASES_LIST_ID,
    REVIEW_SORTS,
    SEARCH_SORTS,
...
from marketplace_mcp.models.catalog import (
    BoughtItems,
    Cheaper,
    DeliveryEstimate,
    Description,
...
from marketplace_mcp.models.orders import OrderProduct
from marketplace_mcp.parsing import catalog as parse
from marketplace_mcp.parsing.common import declared_counter, next_pages
from marketplace_mcp.parsing.orders import ORDER_NUMBER_RE, order_numbers_from_link, parse_order_products
...
def bought_items(
    ...
    """
    from marketplace_mcp.services.orders import list_orders  # ruff: ignore[import-outside-top-level] - avoids a cycle
