...
from marketplace_mcp.errors import OrdersDisabledError, OzonError, TotalMismatchError
from marketplace_mcp.models.checkout import Checkout, Delivery, OrderPlaced, PaymentOption, PickupPoint
from marketplace_mcp.models.enums import PostPaymentScope
from marketplace_mcp.parsing.checkout import (
    parse_checkout,
    parse_pickup_points,
...
def start_checkout(*, with_points: bool = True, with_shipments: bool | None = None) -> Checkout:
    ...
    from marketplace_mcp.services.cart import get_cart  # ruff: ignore[import-outside-top-level] - avoids a cycle
