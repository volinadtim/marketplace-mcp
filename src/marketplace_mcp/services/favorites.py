...
from marketplace_mcp.parsing import catalog as catalog_parse
from marketplace_mcp.parsing.common import find_all
...
def list_favorites(limit: int = 100) -> list[Tile]:
    ...
    from marketplace_mcp.services.catalog import _paginate_tiles  # ruff: ignore[import-outside-top-level]
