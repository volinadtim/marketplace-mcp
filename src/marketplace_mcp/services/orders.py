...
from marketplace_mcp.models.checkout import CancelReason, OrderCancelled, PaymentRequested
from marketplace_mcp.models.enums import OrderState
from marketplace_mcp.models.orders import Order, OrderDetail, Return
from marketplace_mcp.parsing.common import find_all, walk, widget, widgets_all
from marketplace_mcp.parsing.orders import (
    ORDER_NUMBER_RE,
...
def _select_postings(order: str, modal: str, skus: list[str]) -> dict[str, Any]:
    ...
    from marketplace_mcp.services.catalog import order_products  # ruff: ignore[import-outside-top-level]
...
def _gap(amount: str | None) -> str | None:
    ...
    from marketplace_mcp.services.finance import get_finances  # ruff: ignore[import-outside-top-level] - avoids a cycle
